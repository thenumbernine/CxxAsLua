...
void bar_vv() { print("bar_vv"); }
void bar_vi(int i) { print("bar_vi", i); ASSERT_EQUALS(i, 20); }
int bar_iv() { print("bar_iv"); return 10; }
int bar_ii(int i) { print("bar_ii", i); ASSERT_EQUALS(i, 20); return 10; }
